...
function inspect(value, options) {
  ...
  if (options.showHidden != null)
    inspector.showHidden = Boolean(options.showHidden);

  if (options.maxArrayLength != null)
    inspector.maxArrayLength = options.maxArrayLength >>> 0;

  if (options.sort != null)
    inspector.sort = Boolean(options.sort);

  if (options.colors != null)
    inspector.colors = Boolean(options.colors);
